...
public class InvokeVote {
        ...
        public static void doVote(String orgName, String userName, String functionName, String key, String name) 
            ...
            try (Gateway gateway = builder.connect()) {
                ...
                System.out.println("You have a vote for"+name);
            }
        }
        public static void main(String[] args) {
            try {
                doVote(args[0], args[1], "Vote", "vote02", "B");
