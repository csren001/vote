...
public class EnrollAdmin {
	...
	public static void main(String[] args) throws Exception {
		if (args[0].equals("Org1")) doEnroll(CA_CERT_ORG1, ORGNAME_ORG1, MSPID_ORG1, ADMINNAME_ORG1, ADMINPWD_ORG1);
		else if (args[0].equals("Org2")) doEnroll(CA_CERT_ORG2, ORGNAME_ORG2, MSPID_ORG2, ADMINNAME_ORG2, ADMINPWD_ORG2);
		else System.out.println(args[0]+" doesn't exits");
	}
}
